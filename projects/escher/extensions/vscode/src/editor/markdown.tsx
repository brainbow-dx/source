...
export class MarkdownEditor implements CustomTextEditorProvider {
        ...
        return `
            ...
            <head>
                ...
                <meta http-equiv="Content-Security-Policy" content="
                    ...
                    font-src 'self' ${panel.webview.cspSource} ${excalidrawAssetsPrefix} data:;
                    img-src 'self' ${panel.webview.cspSource} ${excalidrawAssetsPrefix} data:;
            ...
            <body>
                <main id="root" class="document">
                    ...
                    <textarea id="code" class="editor">${documentContent}</textarea>
                    <iframe id="content" class="display">
