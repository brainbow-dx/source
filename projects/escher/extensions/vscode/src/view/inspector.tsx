...
import { parseMarkup } from "@escher/parse/markup";
...
//---
export class SketchInspector implements WebviewViewProvider {
    ...
    public draw(view: WebviewView): string {
        ...
        return `
            ...
            <head>
                ...
                <script>
                    window.EXCALIDRAW_ASSET_PATH = "https://cdn.jsdelivr.net/npm/@excalidraw/excalidraw/dist/prod/";
