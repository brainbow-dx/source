...
//---
export class SketchExplorer implements WebviewViewProvider {
        ...
        return `
            ...
            <head>
                ...
                <script>
                    ...
                    window.EXCALIDRAW_ASSET_PATH = "${excalidrawAssetsPrefix}/dist/prod/";
                    
                    // window.SKETCH_ASSET_PATH = "/";
                </script>
