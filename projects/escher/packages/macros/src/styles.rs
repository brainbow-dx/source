    ...
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        let styles = self.styles.iter().map(|(key, value)| {
            ...
            quote! {
                ...
                let #key = move |stylesheet: &mut escher::style::StyleSheet<'_>| {
                    // Some Sensible imports for composability in the UIx block.
                    // TODO: Allow this to be set by the caller (with sensible defaults).
                    use escher::style::primitive::*;
                    use escher::style::primitive::Unit::*;
                    use escher::style::property::*;
                    use escher::event::EventKind::*;
