//! The toolbar/tab-strip data model itself, what to show and what happened, kept apart from
...
//! well hand to some other engine's ECS, or to no ECS at all. Burying them inside a file whose
...
/// (see `TabStripState::icon_only`) instead of continuing to narrow the labeled one. Same
