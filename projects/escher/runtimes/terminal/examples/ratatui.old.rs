...
use escher_surface::Surface;
use escher_scaffold::Scaffold;
use escher_style::Unit;
use escher_style::Size;
use escher_style::Flex;
use escher_style::FlexDirection;
use escher_style::BackgroundColor;
use escher_style::Border;

use escher_event::Click;
use escher_event::DoubleClick;

use escher_element::Text;
use escher_element::Element;
use escher_content::Content;

use escher_terminal_ratatui::RatatuiSurface;
        ...
        terminal
            ...
            .with_slot::<Body>(|console, _| {
                ...
                console
                    ...
                    // crate with a "ui" feature for Escher types.
...
pub mod escher_surface {
    ...
    use crate::escher_draw::DrawUpdate;
    use crate::escher_scaffold::Scaffold;
...
pub mod escher_scaffold {
    ...
    use crate::escher_collections::OrderedMap;
    use crate::escher_draw::DrawContext;
    use crate::escher_content::Content;
    use crate::escher_element::Element;
    use crate::escher_style::Style;
    use crate::escher_style::StyleSheet;
    use crate::escher_style::StyleValue;
...
//---
pub mod escher_terminal {
    #![allow(unused)]
    
    use crate::escher_surface::Surface;
    use crate::escher_scaffold::Scaffold;
...
//---
pub mod escher_terminal_ratatui {
    #![allow(unused)]
    ...
    use crate::escher_content::LineCounter;
    use crate::escher_style::Border;
    use crate::escher_style::FlexDirection;
    use crate::escher_style::Heading;
    use crate::escher_style::Size;
    use crate::escher_style::StyleValue;
    use crate::escher_style::Value;
    use crate::escher_surface::Surface;
    use crate::escher_scaffold::Scaffold;
...
pub mod atlas_tracing {
    ...
    //! the subscriber by hand while solving Escher's core problems, so I took
