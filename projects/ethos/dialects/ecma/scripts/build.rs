...
fn main() -> Result<ExitCode> {
    ...
    csbindgen::Builder::default()
        // TODO: Build the list of input files pragmatically, from fs.
        ...
        .csharp_class_name("EcmaRuntime") // TODO: Change to `NativeBindings``
        .csharp_use_function_pointer(false) // TODO: Can we make this true?
        .csharp_type_rename(map_type_names)
        .generate_csharp_file("./.output/unity/EcmaRuntime.g.cs")
