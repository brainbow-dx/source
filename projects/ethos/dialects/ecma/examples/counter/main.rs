...
use ethos_ecma::bootstrap::ffi::CBootstrapOptions;
use ethos_ecma::logging::ffi::CEcmaRuntimeLogLevel;
use ethos_ecma::runtime::ffi::CEcmaRuntimeConfig;
use ethos_ecma::start::ffi::CExecuteModuleOptions;
...
fn main() -> Result<ExitCode> {
    ...
    ethos_ecma::tracing::mount(TRACING_FILTER);
    ...
    unsafe {
        ...
        let runtime = ethos_ecma::runtime::ffi::c_construct_runtime({
            CEcmaRuntimeConfig {
        ...
        let status = ethos_ecma::runtime::ffi::c_exec_module(runtime, CExecuteModuleOptions {
